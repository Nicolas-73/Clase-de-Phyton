const API_URL = 'https://apibox.vercel.app/6pfqodg6KcghTiOxcXLgIhksnhbSzTD1/api/corredores'
    ...
    li.innerHTML = `
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center gap-2 mt-1">
          <span class="text-[11px] font-mono px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-700">${corredor.categoría}</span>
...
// TODO: Implementar el botón actualizar de cada corredor de la lista
