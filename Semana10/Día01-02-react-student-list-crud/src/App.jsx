const App = () => {
  return (
    <main className="w-96 mx-auto border border-slate-400 rounded-lg mt-6 p-4">
      <h1 className="text-2xl text-center text-slate-700 font-bold mb-4">Students CRUD</h1>
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          />
          <input 
            className="bg-slate-500 text-white hover:bg-slate-900 font-medium rounded-lg text-sm w-full px-4 py-2 text-center cursor-pointer"
            type="reset" 
            value="Clear"
          />
        </div>
